...
% Last Modified by GUIDE v2.5 08-Apr-2016 17:04:05
...
half = 1000;
citra_cropp = pic(pusat_bar - half : pusat_bar + half - 1, pusat_kol - half : pusat_kol + half - 1, : );
axes(handles.axes2);
imshow(citra_cropp);
...
function ekstraksi_ciri_Callback(hObject, citra_warna, handles)
...
[CiriASM CiriCON CiriCOR CiriVAR2 CiriIDM CiriENT2] = CiriOrdeDua(citra_warna);

ciri_orde_satu_data_uji = [CiriMEAN CiriVAR CiriSKEW CiriKURT CiriENT];
ciri_orde_dua_data_uji = [CiriASM CiriCON CiriCOR CiriVAR2 CiriIDM CiriENT2];
...
kelas_data_uji = knnclassify(data_uji, data_latih, grup_kelas, pil_k,pil_distance, pil_rule);
